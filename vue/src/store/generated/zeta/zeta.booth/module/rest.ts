...
export interface BoothMsgCastVoteForPollResponse {
  /** @format uint64 */
  voteId?: string;
}
...
export interface BoothVoteParams {
   ...
   */
  buyerReturn?: V1Beta1Coin;

  /** @format uint64 */
  buyerJailTime?: string;

  /** @format uint64 */
  sellerJailtime?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryVoteAll = (
    ...
    this.request<BoothQueryAllVoteResponse, RpcStatus>({
      path: `/zeta/booth/vote`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/zeta/booth/vote/{voteId}
   */
  queryVote = (voteId: string, params: RequestParams = {}) =>
    this.request<BoothQueryGetVoteResponse, RpcStatus>({
      path: `/zeta/booth/vote/${voteId}`,
      method: "GET",
      format: "json",
      ...params,
    });

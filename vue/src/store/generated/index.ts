...
import ZetaZetaBooth from './zeta/zeta.booth'
import ZetaZetaEscrow from './zeta/zeta.escrow'
import ZetaZetaMarket from './zeta/zeta.market'
import ZetaZetaWhitelist from './zeta/zeta.whitelist'
...
export default { 
  ...
  ZetaZetaBooth: load(ZetaZetaBooth, 'zeta.booth'),
  ZetaZetaEscrow: load(ZetaZetaEscrow, 'zeta.escrow'),
  ZetaZetaMarket: load(ZetaZetaMarket, 'zeta.market'),
  ZetaZetaWhitelist: load(ZetaZetaWhitelist, 'zeta.whitelist'),

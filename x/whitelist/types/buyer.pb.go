...
type Buyer struct {
	...
	ActiveOrder    []uint64 `protobuf:"varint,6,rep,packed,name=activeOrder,proto3" json:"activeOrder,omitempty"`
	CompletedOrder []uint64 `protobuf:"varint,7,rep,packed,name=completedOrder,proto3" json:"completedOrder,omitempty"`
}
...
func (m *Buyer) GetActiveOrder() []uint64 {
	if m != nil {
...
func (m *Buyer) GetCompletedOrder() []uint64 {
	if m != nil {
...
func init() {
	proto.RegisterType((*Buyer)(nil), "zeta.whitelist.Buyer")
}
...
var fileDescriptor_aea94ae1e5bf3227 = []byte{
	...
	,
}
...
func (m *Buyer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.CompletedOrder) > 0 {
		...
		i = encodeVarintBuyer(dAtA, i, uint64(j1))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ActiveOrder) > 0 {
		...
		i = encodeVarintBuyer(dAtA, i, uint64(j3))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Status) > 0 {
	...
	if len(m.Address) > 0 {
		...
		i = encodeVarintBuyer(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ContactInfo) > 0 {
		...
		i = encodeVarintBuyer(dAtA, i, uint64(len(m.ContactInfo)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintBuyer(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x12
	}
	if m.BuyerId != 0 {
		i = encodeVarintBuyer(dAtA, i, uint64(m.BuyerId))
		i--
		dAtA[i] = 0x8
	}

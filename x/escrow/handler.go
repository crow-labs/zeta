...
func NewHandler(k keeper.Keeper) sdk.Handler {
	...
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgRaiseBuyerDispute:
			...
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgAddSellerEvidence:
			res, err := msgServer.AddSellerEvidence(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)
		case *types.MsgAddBuyerEvidence:
			res, err := msgServer.AddBuyerEvidence(sdk.WrapSDKContext(ctx), msg)
			return sdk.WrapServiceResult(ctx, res, err)

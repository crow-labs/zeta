...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta", "escrow", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Crow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"zeta", "escrow", "crow", "crowId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CrowAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta", "escrow", "crow"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Dispute_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"zeta", "escrow", "dispute", "disputeId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DisputeAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"zeta", "escrow", "dispute"}, "", runtime.AssumeColonVerbOpt(true)))
)
